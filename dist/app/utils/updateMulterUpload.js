...
exports.updateMulterUpload = exports.uploadFileToSpaceForUpdate = void 0;
...
const s3 = new client_s3_1.S3Client({
    ...
    credentials: {
        accessKeyId: config_1.default.s3.do_space_accesskey || '',
        secretAccessKey: config_1.default.s3.do_space_secret_key || '',
    },
});
...
exports.uploadFileToSpaceForUpdate = uploadFileToSpaceForUpdate;
//upload utilities function multer.ts file import multer from "multer";
const updateMulterUpload = (0, multer_1.default)({
...
exports.updateMulterUpload = updateMulterUpload;
