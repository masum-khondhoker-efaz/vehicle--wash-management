...
const addCouponIntoDB = (userId, couponData) =>
...
const updateCouponIntoDB = (userId, couponId, couponData) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const applyPromoCodeIntoDB = (userId, promoCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    if (promoCode.serviceType === client_1.ServiceType.PREMIUM) {
      if (service.servicePremiumPrice !== null) {
        servicePrice =
          ...
          (service.servicePremiumPrice *
            ((_a = promo.percentage) !== null && _a !== void 0 ? _a : 0)) /
            100;
      } else {
        throw new AppError(
          httpStatus.CONFLICT,
          'Service premium price is null',
        );
      }
    }
    if (promoCode.serviceType === client_1.ServiceType.NORMAL) {
      servicePrice =
        ...
        (service.servicePrice *
          ((_b = promo.percentage) !== null && _b !== void 0 ? _b : 0)) /
          100;
    }
