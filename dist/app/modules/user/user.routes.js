...
router.get('/', (0, auth_1.default)('ADMIN', 'SUPER_ADMIN', 'CUSTOMER'), user_controller_1.UserControllers.getAllUsers);
router.get('/me', (0, auth_1.default)('CUSTOMER', 'ADMIN', 'SUPER_ADMIN', 'DRIVER'), user_controller_1.UserControllers.getMyProfile);
router.get('/:id', (0, auth_1.default)('ADMIN', 'SUPER_ADMIN'), user_controller_1.UserControllers.getUserDetails);
router.put('/update-profile', (0, auth_1.default)('CUSTOMER', 'ADMIN', 'CUSTOMER', 'DRIVER'), user_controller_1.UserControllers.updateMyProfile);
...
router.patch('/change-password', (0, auth_1.default)(), user_controller_1.UserControllers.changePassword);
